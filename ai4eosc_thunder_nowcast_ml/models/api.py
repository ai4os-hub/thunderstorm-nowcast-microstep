...
def train(**kwargs):
    ...
    try:
        ...
        with mlflow.start_run():
            ...
            print_log(f"mlflow.log_param('AREA list', {dtm_tr['dataset_input'][0]['AREA_list']})")
            mlflow.log_param("AREA list input", dtm_tr["dataset_input"][0]["AREA_list"])
            print_log(f"mlflow.log_param('AREA list', {dtm_tr['dataset_output'][0]['AREA_list']})")
            mlflow.log_param("AREA list output", dtm_tr["dataset_output"][0]["AREA_list"])
